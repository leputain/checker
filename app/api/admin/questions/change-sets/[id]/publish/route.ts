...
import { publishQuestionBankChangeSet } from '@/lib/question-bank-workflow.ts';
...
export async function POST(request: Request, context: { params: Promise<{ id: string }> }) {
  try {
    ...
    return questionAdminJson(await publishQuestionBankChangeSet(
      database(),
      id,
    ...
    console.error('admin_change_set_publish_failed');
